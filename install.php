        ...
        <div class="col-mb-12 col-tb-8 col-tb-offset-2">
            ...
            <?php if (isset($_GET['finish'])) : ?>
                ...
                <div class="typecho-install-body">
                    ...
                    <a target="_blank" href="https://spreadsheets.google.com/viewform?key=pd1Gl4Ur_pbniqgebs5JRIg&hl=en">参与用户调查, 帮助我们完善产品</a>
                    </div>
...
<p><button name="created" value="1" type="submit" class="btn primary"><?php _e('创建完毕, 继续安装 &raquo;'); ?></button></p></div>
            ...
            <?php  else: ?>
                ...
                <h2><?php _e('许可及协议'); ?></h2>
                <p><?php _e('Typecho 基于 <a href="https://www.gnu.org/copyleft/gpl.html">GPL</a> 协议发布, 我们允许用户在 GPL 协议许可的范围内使用, 拷贝, 修改和分发此程序.'); ?>
